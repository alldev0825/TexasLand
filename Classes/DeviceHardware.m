...
#define DH_MACHINE_IPHONE_3_2 @"iPhone3,2"
...
+ (NSString *)platformString {
    ...
    if ([platform isEqualToString:DH_MACHINE_IPHONE_3_2])    return @"iPhone 4";
	...
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_1])      return @"iPad 2";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_2])      return @"iPad 2";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_3])      return @"iPad 2";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_4])      return @"iPad 2";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_5])      return @"iPad Mini";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_6])      return @"iPad Mini";
	if ([platform isEqualToString:DH_MACHINE_IPAD_2_7])      return @"iPad Mini";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_1])      return @"iPad 3";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_2])      return @"iPad 3";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_3])      return @"iPad 3";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_4])      return @"iPad 4";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_5])      return @"iPad 4";
	if ([platform isEqualToString:DH_MACHINE_IPAD_3_6])      return @"iPad 4";
	if ([platform isEqualToString:DH_MACHINE_IPAD_4_1])      return @"iPad Air";
	if ([platform isEqualToString:DH_MACHINE_IPAD_4_2])      return @"iPad Air";
	if ([platform isEqualToString:DH_MACHINE_IPAD_4_4])      return @"iPad Mini Retina";
	if ([platform isEqualToString:DH_MACHINE_IPAD_4_5])      return @"iPad Mini Retina";
